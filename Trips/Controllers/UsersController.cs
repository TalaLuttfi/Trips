...
namespace Trips.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(DbTripsContext context)
        {
            _context = context;
        }
        ...
        {
            var dbTripsContext = _context.Users.Include(u => u.Role);
        ...
        public async Task<IActionResult> Create([Bind("Id,Fullname,Username,UPassword,PhoneNum,Gender,Imagepath,RoleId")] User user)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DbTripsContext.Users'  is null.");
            }
            var user = await _context.Users.FindAsync(id);
            if (user != null)
            {
